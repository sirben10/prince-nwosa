...
if(isset($_POST['submit']))
{
	...
	$user_select = "SELECT * FROM admin WHERE loginname='".$_POST['username']."' and loginpwd='".md5($password)."'";
...
<head>
	...
	<?php include('../assets/og-image.php'); ?>
</head>
<body class="login">
	<div>
		...
		<div class="login_wrapper">
			<div class="animate form login_form">
				<section class="login_content">
					...
					<div class="logo mb-4">
						<img style="height: 150px;" class="img-fluid" src="../assets/img/logo/favicon.png" alt="logo"/>
					</div>
						<fieldset>
							<legend>
								Admin Login
